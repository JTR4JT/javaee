    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="inoutgoods" action="${pageContext.request.contextPath}/goods_type/updateGoods_type">
                    <table id="inoutTab" class="table table-bordered table-striped" width="800px">
                        <tr>
                            <td>商品类型ID</td>
                            <td><input readonly class="form-control"  name="g_type_id" id="g_type_id" value="${goods_typebyid.g_type_id}"></td>
                            <td>商品类型名称</td>
                            <td><input class="form-control"  name="g_type_name" id="g_type_name" value="${goods_typebyid.g_type_name}"></td>
                        </tr>
                    </table>
